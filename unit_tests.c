...
/*   Updated: 2020/01/07 10:07:24 by thgermai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int precision_0_int_1(void){return test("%.0i", 0);}
int precision_0_int_2(void){return test("%.0i", 123);}
int precision_0_int_3(void){return test("%10.0i", 0);}
int precision_0_int_4(void){return test("%10.0i", 123);}

int precision_0_hexa_1(void){return test("%.0x", 0);}
int precision_0_hexa_2(void){return test("%.0x", 123);}
int precision_0_hexa_3(void){return test("%10.0x", 0);}
int precision_0_hexa_4(void){return test("%10.0x", 123);}
